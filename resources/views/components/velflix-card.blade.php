...
<div class="p-1 swiper-slide">
    <div  class="flex flex-col overflow-hidden bg-black rounded shadow" x-data="{ hover:false }">
        <div x-on:mouseover="hover = true" x-on:mouseout="hover = false" class="flex-shrink-0">
